...
public class NavigationViewInfoParcelable extends HistoryNavigable {
    ...
    public void setSelectedDir(String selectedDir){
    	this.mSelectedDir = selectedDir;
    }
    
    public String getSelParentDir(){
    	return this.mSelParentDir;
    }
    
    public void setSelParentDir(String selParentDir){
    	this.mSelParentDir = selParentDir;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.mSelectedDir);
        dest.writeString(this.mSelParentDir);
    ...
    private void readFromParcel(Parcel in) {
        ...
        this.mSelectedDir = in.readString();
        this.mSelParentDir = in.readString();
